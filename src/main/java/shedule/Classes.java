...
public enum Classes {
    ...
    SP_10("10 СП", 5, Arrays.asList("10 СП-1", "10 СП-3")),
    M_11("11 МАТ", 1, Arrays.asList("11 МАТ-1", "11 МАТ-2")),
    ...
    private static List<Classes> class_11 = Arrays.asList(M_11, ENJ_11, EN_11, IF_11, SE_11);
